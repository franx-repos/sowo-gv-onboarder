...
function Sidebar({ membersCount }) {
  ...
  const style = {
    ...
    input:
      "w-1/2 lg:w-1/3 text-md lg:text-xl rounded-e-md lg:mb-3 p-2 bg-neutral-800  placeholder-neutral-400 text-white focus:outline-none focus:ring focus:ring-pink-700 focus:rounded-md",
  };
  ...
  return (
    <div className="flex flex-row lg:flex-col flex-wrap order-1 lg:order-0 h-1/6 lg:h-full bg-neutral-950 justify-center p-2 lg:p-5 rounded-b-lg lg:rounded-s-3xl lg:rounded-br-none lg:border-r-4 border-pink-800 gap-2">
      <div className="flex w-[48%] lg:w-full">
        <p className="lg:mb-3 w-1/2 lg:w-2/3 text-white text-md lg:text-xl p-2 rounded-s-md bg-neutral-800">
          insgesamt:
        </p>
        <input
