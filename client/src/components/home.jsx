...
const Home = () => {
  ...
  useEffect(() => {
    setHasQuorum(members.length > totalMembers / 2);
  ...
  return (
    <div className="flex flex-col w-screen h-screen bg-pink-800 px-5 pb-5">
      ...
      <div className="flex h-full overflow-x-hidden">
        <div className="flex h-full bg-neutral-950 flex-col p-5 rounded-s-3xl">
          <div className="flex">
            ...
            <input
              ...
              type="number"
              min={0}
              className="w-20 text-xl rounded-e-md mb-3 p-2 bg-neutral-800  placeholder-neutral-400 text-white focus:border-pink-700"
